...
public class CameraRemoteSampleApp extends Activity {
    ...
    protected void onResume() {
        ...
        if (wifiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLED) {
            ...
            textWifiSsid.setText(R.string.sony_msg_wifi_disconnect);
        }
                    ...
                    public void run() {
                        ...
                        if (mActivityActive) {
                            Toast.makeText(CameraRemoteSampleApp.this,
                                    R.string.sony_msg_device_search_finish,
            ...
            public void onErrorFinished() {
                ...
                mHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (mActivityActive) {
                            Toast.makeText(CameraRemoteSampleApp.this,
                                    R.string.sony_msg_error_device_searching,
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void launchSampleActivity(ServerDevice device) {
        ...
        if (device.hasApiService("camera")) {
            ...
            Toast.makeText(this, R.string.sony_msg_error_non_supported_device,
                    Toast.LENGTH_SHORT).show();
        }
    }
